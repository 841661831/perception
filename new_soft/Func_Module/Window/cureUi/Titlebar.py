...
class Titlebar(QWidget):
    ...
    MIN_BUTT_SIZE = QSize(26, 22)
    RET_BUTT_SIZE = QSize(26, 22)
    CLOSE_BUTT_SIZE = QSize(26, 22)
    ...
    def __init__(self, parent, icon_name):
        ...
        self.m_pReturnButton.setStyleSheet("QPushButton{border-image: url(./beautifyUi/blueDeep/zoomout.png)}")
        # 统一设置ObjName
    ...
    def mouseReleaseEvent(self, event):
        ...
        # pWindow = self.window()
        # if pWindow.isWindow():
        #     self.parentwidget.move(event.pos() - self.mPos)
        # self.mPos = None
        event.accept()
    ...
    def mouseMoveEvent(self, event):
        ...
        #     if pWindow.isWindow():
        #         pWindow.move(event.pos() - self.mPos)
        ...
        if event.buttons() == Qt.LeftButton and self.mPos:
            ...
            self.mPos = event.globalPos()
            self.parentwidget.move(self.parentwidget.pos() + movePos)
        #event.accept()
    ...
    def __slot_onclicked(self):
        ...
        if pWindow.isWindow():
            ...
            if pButton.objectName() == Titlebar.MIN_BUTT_NAME:
                ...
                self.parentwidget.ui_MainWindowQuit()
                #self.close()
    ...
    def closeEvent(self,event):
        ...
        self.actionQuit.triggered.connect(self.parentwidget.slotQuit)
