...
class WindowWithTitleBar(QFrame):
    def __init__(self, mainwidget, icon_name, parent=0):
        ...
        #self.MainWindow.setStyleSheet("MainWindow{background-color: #C0C0C0}")
    ...
    def mouseMoveEvent(self, event):
        ...
        self.mainwidget.mouseMoveEvent(event)
        return super().mouseMoveEvent(event)
    ...
    def mousePressEvent(self, event):
        ...
        self.mainwidget.mousePressEvent(event)
    ...
    def mouseReleaseEvent(self, event):
        ...
        self.m_isMousePressed = False
        self.calculateCurrentStrechRect()
        self.mainwidget.mouseReleaseEvent(event)
        return super().mouseReleaseEvent(event)

    def ui_MainWindowQuit(self):
        self.MainWindow.slotQuit()
